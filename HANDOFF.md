...
最後更新：2026-09-02 深夜（**胰臟癌真題目跑到採集完成，停在「用什麼資料」這個決定**）
...
**專案 `88bb63ee-2c6a-4386-9377-608ef62d81bf`**，預算 $2，**已花 $0.91，剩 $1.09**。
...
`POST /compute/chain/resume {"project_id":"88bb63ee-..."}`
W6 已經把 `tiers=B,C` 放進 params 往下傳。預算不夠的話先把 `max_ideas` 調小。
